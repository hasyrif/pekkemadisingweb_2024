...
<head>
  ...
  <!-- css untuk mempercantik tombol export di datatable -->
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ url('AdminLTE/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Pekke Madising</span>
    </a>
...
<!-- tambahan kode export to pdf,excel pada datatable -->
